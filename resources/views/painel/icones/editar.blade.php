                ...
                <div class="card-body">
                    ...
                    <form action="/painel/icones/alterar" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="icones_categorias_id" id="categoria" class="form-control"
                                        autocomplete="on">
                                    <option value="{{ $icone->icones_categorias_id }}" selected>{{ $icone->iconesCategoria->nome }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="caminho">
                                    <option value="{{ $icone->caminho }}" selected>{{ $icone->nome }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label>Link:</label>
                                <input type="text" name="link" id="link" class="form-control" value="{{ $icone->link }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label>Nome:</label>
                                <input type="text" name="nome" id="nome" class="form-control" value="{{ $icone->nome }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="subtitulo" id="subtitulo" class="form-control"
                                       value="{{ $icone->subtitulo }}" placeholder="Informe o Subtítulo">
