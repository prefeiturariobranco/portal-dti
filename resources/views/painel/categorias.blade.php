...
@section('titulo')Intranet :: Categorias @endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <button class="btn btn-success" style="margin-bottom: 1%;" type="button" data-toggle="modal" data-target="#modalAdd">Adicionar Categoria</button>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="/painel/categorias/cadastrar">
                    <div class="form-group">
                        ...
                        <input type="text" name="categoria" id="categoria" class="form-control" placeholder="Digite o nome">
...
<div id="modalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success waves-effect waves-light btn-editar">Salvar Alterações</button>
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Fechar</button>
                </form>
            </div>
        </div>
